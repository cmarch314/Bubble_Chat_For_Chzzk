...
window.HIVE_VOLUME_CONFIG = {
    ...
    sfx: 0.55     // Multiplier for standard sound effects
};
...
window.WELCOME_MESSAGES = [
    ...
    "와!샌즈! 겁.나.어.렵.습.니.다", "왜나만 억까당해 진짜 짜증나", "시발롬 아 적당히 좀 해라", "뉴스도안 보고 사냐 임마", "테레비도안 보냐? 요즘 유행인데",
...
window.HIVE_SOUND_CONFIG = {
    ...
    "그땐몰랐": { "src": "그땐몰랐어.mp3", "volume": 0.7 },
    "그래서재미": { "src": "Life4.mp3", "volume": 0.7 },
    "기모띠": { "src": "kimotee.mp3", "volume": 0.7 },
    "기침소리": { "src": "WhoJustCoughed.mp3", "volume": 0.7 },
    ...
    "나가뒤지기": { "src": "SunFlower-GetOut.mp3", "volume": 0.7 },
    ...
    "먹고살기": { "src": "먹고살기힘들다.mp3", "volume": 0.7 },
    ...
    "스트필요": { "src": "StressNeeds.mp3", "volume": 0.7 },
    ...
    "안 돼잖아": { "src": "Half-not-working.mp3", "volume": 0.7 },
    ...
    "저븅신": { "src": "SunFlower-ThatRetard.mp3", "volume": 0.7 },
    ...
    "귀찮아귀찮아": { "src": "귀찮아귀찮아.mp3", "volume": 0.7 },
    ...
    "근무시간": { "src": "근무나갈시간.mp3", "volume": 0.7 },
    "금오환": { "src": "금오환.mp3", "volume": 0.7 },
    "기가맥": { "src": "기가맥.mp3", "volume": 0.8 },
    "기쁨이폭발": { "src": "기쁨이폭발.mp3", "volume": 0.7 },
    "기억도나지": { "src": "기억도나지않는다.mp3", "volume": 0.7 },
    "기폭용항": { "src": "기폭용항.mp3", "volume": 0.7 },
    "꺼져!": { "src": "꺼져2.mp3", "volume": 0.7 },
    "꼬드않": { "src": "꼬드않.mp3", "volume": 0.7 },
    "꼬리!": [
    ...
    "몸솔찍": [
        { "src": "몸솔찍.mp3", "volume": 0.7 },
        { "src": "몸은솔찍해.mp3", "volume": 0.7 }
    ],
    "못생겼어": [
        { "src": "못생겼어.mp3", "volume": 0.7 },
        { "src": "못생겼어2.mp3", "volume": 0.7 }
    ],
    "몽충몽충": { "src": "몽충몽충.mp3", "volume": 0.7 },
    ...
    "곤니찌와": { "src": "미나상곤니찌와.mp3", "volume": 0.7 },
    ...
    "보세최겜": { "src": "보아라세최겜.mp3", "volume": 0.7 },
    ...
    "상쾌해": { "src": "상쾌해.mp3", "volume": 0.9 },
    "서프라이즈": { "src": "서프라이즈!.mp3", "volume": 0.7 },
    ...
    "씹쓰겜": { "src": "씹쓰겜.mp3", "volume": 0.7 },
    "아~합시다": { "src": "아합시다.mp3", "volume": 0.7 },
    "아가지마": { "src": "아가지마.mp3", "volume": 0.7 },
    ...
    "안접맹세": { "src": "안접는다고맹세.mp3", "volume": 0.7 },
    ...
    "어떤새": { "src": "어떤새.mp3", "volume": 0.7 },
    "어머어머": { "src": "어머어머.mp3", "volume": 0.7 },
    "어예": { "src": "어예.mp3", "volume": 0.7 },
    "어우눈부셔": { "src": "어우눈부셔.mp3", "volume": 0.7 },
    ...
    "역시!": { "src": "역시!.mp3", "volume": 0.7 },
    "역시슬액": { "src": "역시슬액.mp3", "volume": 0.7 },
    "역신컨": { "src": "역신컨.mp3", "volume": 0.7 },
    "열시간몬헌": { "src": "열시간몬헌.mp3", "volume": 0.7 },
    "엿이나드셔": { "src": "엿이나드셔.mp3", "volume": 0.7 },
    "엿이나드셔~": { "src": "엿이나드셔2.mp3", "volume": 0.7 },
    "옆영침": { "src": "옆영침.mp3", "volume": 0.7 },
    "예민하네": { "src": "예민하네.mp3", "volume": 0.7 },
    "예스!": { "src": "예스.mp3", "volume": 0.7 },
    "오게이!": { "src": "오게이.mp3", "volume": 0.7 },
    "오겡끼데스까": { "src": "오겡끼데스까.mp3", "volume": 0.7 },
    "오격추": { "src": "오격추.mp3", "volume": 0.7 },
    "오꼬짤": { "src": "오꼬짤.mp3", "volume": 0.7 },
    "오끄소": { "src": "오끄소.mp3", "volume": 0.7 },
    "오나즈치": [
    ...
    "왜유투브": { "src": "이걸왜유투브.mp3", "volume": 0.7 },
    ...
    "이렇게갓겜": { "src": "이렇게갓겜.mp3", "volume": 0.7 },
    "이맛에": { "src": "이맛에.mp3", "volume": 0.7 },
    "이무컨": { "src": "이무컨.mp3", "volume": 0.7 },
    ...
    "자제해야돼": { "src": "자제해야되.mp3", "volume": 0.7 },
    ...
    "장난마": [
        { "src": "장난마.mp3", "volume": 0.7 },
        { "src": "장난하지마.mp3", "volume": 0.7 },
        { "src": "장난하지마2.mp3", "volume": 0.7 },
        { "src": "장난하지마3.mp3", "volume": 0.7 }
    ],
    "장비변경": { "src": "장비변경을한다.mp3", "volume": 0.7 },
    "재미있는게임이야": { "src": "재미있는게임이야.mp3", "volume": 0.7 },
    "재밌는몬": { "src": "재미있는몬스터.mp3", "volume": 0.7 },
    "재밌었": { "src": "재밌었.mp3", "volume": 0.7 },
    "재수없다": { "src": "재수없다.mp3", "volume": 0.7 },
    "적당히해": { "src": "적당히해.mp3", "volume": 0.7 },
    "전세계는목격": { "src": "전세계는목격.mp3", "volume": 0.7 },
    "절벽": [
        { "src": "절벽!1.mp3", "volume": 0.7 },
        { "src": "절벽2.mp3", "volume": 0.7 },
        { "src": "절벽3.mp3", "volume": 0.7 }
    ],
    "절벽위묘지뒤": [
        { "src": "절벽위묘지뒤1.mp3", "volume": 0.7 },
        { "src": "절벽위묘지뒤2.mp3", "volume": 0.7 },
        { "src": "절벽위묘지뒤3.mp3", "volume": 0.7 },
        { "src": "절벽위묘지뒤4.mp3", "volume": 0.7 },
        { "src": "절벽위묘지뒤5.mp3", "volume": 0.7 },
        { "src": "절벽위묘지뒤6.mp3", "volume": 0.7 },
        { "src": "절벽위묘지뒤7.mp3", "volume": 0.7 },
        { "src": "절벽위묘지뒤8.mp3", "volume": 0.7 },
        { "src": "절벽위묘지뒤9.mp3", "volume": 0.7 },
        { "src": "절벽위묘지뒤10.mp3", "volume": 0.7 }
    ],
    "절벽핥": { "src": "절벽핥.mp3", "volume": 0.7 },
    ...
    "팅!1": { "src": "팅!1.mp3", "volume": 0.7 },
    "팅!2": { "src": "팅!2.mp3", "volume": 0.7 },
    "팅!3": { "src": "팅!3.mp3", "volume": 0.7 },
    "타격음_베기": { "src": "mh_slash_hit.mp3", "volume": 0.7 },
    "타격음_무겁": { "src": "mh_heavy_hit.mp3", "volume": 0.7 },
    ...
    "호옷호우": { "src": "호옷호우.mp3", "volume": 0.7 },
    "호호호우": { "src": "호호호우.mp3", "volume": 0.7 },
    "화가나지않": { "src": "화가나지않.mp3", "volume": 0.7 },
    "화났네": { "src": "화났네.mp3", "volume": 0.7 },
    "회전회오리!": { "src": "회전회오리2.mp3", "volume": 0.9 },
    ...
    "DDT": [
        { "src": "DDT1.mp3", "volume": 0.7 },
        { "src": "DDT2.mp3", "volume": 0.7 },
        { "src": "DDT3.mp3", "volume": 0.7 },
        { "src": "DDT4.mp3", "volume": 0.7 },
...
window.VISUAL_CONFIG = {
    ...
    // ==========================================
    dolphin: {
        duration: 7000,         // 전체 이펙트 지속 시간 (ms) - 사운드 길이 7초 매칭
        soundKey: '돌핀',         // 연결된 사운드 키
        dolphinDelay: 1400,     // 메인 돌핀(서퍼/리더)이 등장하기까지의 지연 시간 (ms) - 1.4초 지연
        surferStartOffset: 1000, // 서퍼 애니메이션 시작 오프셋 (ms) - 앞부분 1초만 스킵하여 우측 화면 경계에서 부드럽게 등장
        ...
        // [Deep Tuning] - 심화 설정
        dolphinScale: 1.2,      // 돌핀/서퍼의 크기 배율 (기본값: 1.2로 줄임, 기존 1.5 대비 20% 감소)
