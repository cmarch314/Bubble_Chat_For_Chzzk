...
window.WELCOME_MESSAGES = [
    ...
    "아~합시다 피곤해도 한 판 더", "개쓰래기게임 삭제한다 ㅡㅡ", "게임이어렵 다고 포기하지 마", "겜안분 컷! 아는 척 금지", "교미교미 냥냥펀치",
    ...
    "삭제각 개쓰래기게임 에휴", "게임이어렵 다고 징징대지 마", "넌 진정한 겜안분 이야 꺼져", "교미교미 신비의 섬으로 가자", "구멍이두개 면 두 번 행복해?",
...
window.HIVE_SOUND_CONFIG = {
    ...
    "새낀건랜서": [{ "src": "이새낀건랜서.mp3", "volume": 0.7 },
