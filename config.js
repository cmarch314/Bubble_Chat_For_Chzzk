...
window.WELCOME_MESSAGES = [
    ...
    "가자부풀버전틀어주세요 신나요!", "갓겜합시다풀버전틀어주세요 제발", "물설산씨티풀버전틀어주세요 웅장", "몬창의왕풀버전틀어주세요 야호", "토끼경단풀버전틀어주세요 냠냠",
...
window.HIVE_SOUND_CONFIG = {
    ...
    "대화가된다": { "src": "대화가된다.mp3", "volume": 0.45 },
    "운동많이된다": { "src": "운동많이된다2.mp3", "volume": 0.45 },
    "자기전에생각": { "src": "자기전에생각.mp3", "volume": 0.45 },
