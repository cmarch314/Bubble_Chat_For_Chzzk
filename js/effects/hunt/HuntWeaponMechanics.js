class HuntWeaponMechanics {
    ...
    static extendedActions() {
        ...
        return {
            ...
            insect_glaive: [
                prep('insect_glaive.extract_red', '벌레 발사 · 빨강 진액', { missingExtract: 'red' }, { addExtract: 'red', atbAfterAction: 65 }, 'wilds-action-class:cGunShotAim', 5),
                prep('insect_glaive.extract_white', '벌레 발사 · 흰색 진액', { missingExtract: 'white' }, { addExtract: 'white', atbAfterAction: 65 }, 'wilds-action-class:cGunShotAim', 5),
                prep('insect_glaive.extract_orange', '벌레 발사 · 주황 진액', { missingExtract: 'orange' }, { addExtract: 'orange', atbAfterAction: 65 }, 'wilds-action-class:cGunShotAim', 5),
                { id: 'insect_glaive.rising_slash', name: '강화 연속베어올리기', dmg: 185, motionValue: 46, requirements: { tripleExtract: true }, effects: { glaiveStep: 1 }, next: ['insect_glaive.tornado_slash'], tags: ['sever', 'multi-hit'], audioCue: 'slash_light', durationTicks: 9, mechanicEvidence: 'wilds-action-class:cBatonUSlashSuper' },
                { id: 'insect_glaive.tornado_slash', name: '비원베기', dmg: 305, motionValue: 76, requirements: { tripleExtract: true, glaiveStep: 1 }, effects: { glaiveStep: 0, airborne: true }, next: ['insect_glaive.descending_thrust'], tags: ['sever', 'multi-hit'], audioCue: 'slash_heavy', durationTicks: 12, mechanicEvidence: 'wilds-action-class:cBatonSpinSlashSuper' },
                { id: 'insect_glaive.descending_thrust', name: '급습찌르기', dmg: 455, motionValue: 114, requirements: { airborne: true }, effects: { airborne: false, glaiveCharge: 0 }, tags: ['sever', 'multi-hit', 'finisher'], audioCue: 'slash_heavy', durationTicks: 15, mechanicEvidence: 'wilds-action-class:cBatonJDiveAttack' },
                prep('insect_glaive.descending_charge_1', '강 급습베기 · 1단 충전', { tripleExtract: true, glaiveCharge: 0 }, { glaiveCharge: 1, atbAfterAction: 70 }, 'wilds-motion-values:strong-descending-slash-lv1', 4),
                prep('insect_glaive.descending_charge_2', '강 급습베기 · 2단 충전', { tripleExtract: true, glaiveCharge: 1 }, { glaiveCharge: 2, atbAfterAction: 68 }, 'wilds-motion-values:strong-descending-slash-lv2', 4),
                { id: 'insect_glaive.strong_descending_slash', name: '강 급습베기', dmg: 576, motionValue: 144, hits: [32, 12, 18, 18, 18, 46], requirements: { tripleExtract: true, glaiveCharge: 2 }, effects: { glaiveCharge: 0, spiralReady: true, atbAfterAction: 45 }, next: ['insect_glaive.rising_spiral_slash'], tags: ['sever', 'multi-hit', 'charge-release', 'heavy'], audioCue: 'slash_heavy', durationTicks: 16, mechanicEvidence: 'wilds-motion-values:strong-descending-slash-lv2-total-144' },
                { id: 'insect_glaive.rising_spiral_slash', name: '비천나선참', dmg: 352, motionValue: 88, hits: [8, 8, 8, 8, 8, 8, 8, 8, 24], requirements: { tripleExtract: true, spiralReady: true }, effects: { spiralReady: false, consumeExtracts: true, airborne: true }, tags: ['sever', 'multi-hit', 'kinsect-joint', 'finisher'], audioCue: 'slash_heavy', durationTicks: 18, mechanicEvidence: 'wilds-motion-values:rising-spiral-lv2-64+kinsect-joint-24' },
                { id: 'insect_glaive.focus_thrust', name: '집중 찌르기 · 삼색 회수', dmg: 240, motionValue: 60, requirements: { airborne: true, monsterWounded: true }, effects: { airborne: false, recoverAllExtracts: true }, tags: ['sever', 'kinsect-joint', 'focus-strike'], audioCue: 'slash_heavy', durationTicks: 13, mechanicEvidence: 'wilds-mechanic:focus-thrust-wound-recover-three-extracts' }
            ],
            light_bowgun: [
            ...
            bow: [
                ...
                { id: 'bow.charged_shot', name: '3단계 모아쏘기', dmg: 285, motionValue: 71, requirements: { bowCharge: 3, minBowStamina: 8 }, effects: { bowCharge: 2, bowPowerStep: 1, bowStamina: -8, tracerGauge: 15 }, next: ['bow.power_shot'], tags: ['ranged', 'charge-release'], audioCue: 'bow_shot', durationTicks: 8, mechanicEvidence: 'wilds-action-class:cShotMaxLv' },
                { id: 'bow.power_shot', name: '강사', dmg: 330, motionValue: 82, hits: [16, 16, 16, 17, 17], requirements: { minBowCharge: 2, bowPowerStep: 1, minBowStamina: 12 }, effects: { bowCharge: 1, bowPowerStep: 2, bowStamina: -12, tracerGauge: 20 }, next: ['bow.power_volley'], tags: ['ranged', 'multi-hit'], audioCue: 'bow_shot', durationTicks: 9, mechanicEvidence: 'wilds-action-class:cGoushaShot' },
                { id: 'bow.power_volley', name: '강사 연계', dmg: 385, motionValue: 96, hits: [16, 16, 16, 16, 16, 16], requirements: { minBowCharge: 1, bowPowerStep: 2, minBowStamina: 16 }, effects: { bowCharge: 0, bowPowerStep: 0, bowStamina: -16, tracerGauge: 24 }, tags: ['ranged', 'multi-hit', 'finisher'], audioCue: 'bow_shot', durationTicks: 11, mechanicEvidence: 'wilds-action-class:cGoushaRapidShot' },
