    ...
    renderLoadout(data) {
        ...
        this.container.innerHTML = `
            <div class="game-hunt-card game-hunt-pregame-card hunt-loadout-board" style="position:relative;">
                ...
                <div class="hunt-loadout-guide" style="background:rgba(42,30,22,.9);border:1px solid #c98534;border-radius:10px;padding:8px 14px;margin:12px auto 5px;max-width:1050px;color:#f5eadb;font-size:1.04rem;">
