...
async function main() {
    console.log("🔍 Searching archive.org for 'monster hunter generations' audio mediatypes...");
    // Search query: generations AND mediatype:audio
    const searchQuery = encodeURIComponent('"monster hunter" AND generations AND mediatype:audio');
