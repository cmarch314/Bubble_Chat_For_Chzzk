...
async function main() {
    console.log("🔍 Searching archive.org for MHX/MHXX/MHGU OST...");
    const searchQuery = encodeURIComponent('title:(monster hunter) AND (generations OR double OR "xx" OR "x") AND ost');
