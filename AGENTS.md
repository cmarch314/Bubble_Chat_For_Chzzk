...
- Hunter reaction visuals consume only committed hit/guard outcomes. `pending`, `invulnerable`, miss, resist, and effect-only judgments never restart hit presentation; focused recovery tests pin runtime and renderer idempotency.
