...
- `HuntEngine.presentHunterImpact` exclusively emits committed typed live reactions; damaging tackles and butt-stumbles stay visibly distinct. Renderers simulate only behind preview flags; silent judgments stay silent. Recovery tests pin ownership/idempotency.
